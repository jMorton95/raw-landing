  ...
  return (
    <div className="my-6 mb-12 font-[sans-serif]">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-6xl max-md:gap-16 max-md:max-w-lg mx-auto mt-24">
        <div className="w-full p-6 rounded-lg mx-auto shadow-[0_4px_14px_-6px_rgba(93,96,127,0.4)] bg-white relative pt-12">
          <svg
            ...
            strokeWidth={1.5}
            stroke="black"
            className="size-6 w-14 h-14 rounded-full absolute right-0 left-0 mx-auto top-2"
          >
            <path
              strokeLinecap="round"
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-800 leading-relaxed">
              ...
              maxime eos aliquid natus, aut laboriosam minima sit quaerat
              temporibus cum. Reprehenderit exercitationem odit dolor iure!
            </p>
          </div>
        ...
        <div className="w-full p-6 rounded-lg mx-auto shadow-[0_4px_14px_-6px_rgba(93,96,127,0.4)] bg-white relative pt-12">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-800 leading-relaxed">
              ...
              repudiandae ipsum? Maxime nobis repellat suscipit minima voluptas
              adipisci enim numquam quia. Ad at doloremque nobis?
            </p>
          </div>
        ...
        <div className="w-full p-6 rounded-lg mx-auto shadow-[0_4px_14px_-6px_rgba(93,96,127,0.4)] bg-white relative pt-12">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-800 leading-relaxed">
              ...
              repellendus similique dolore sunt omnis, voluptatem quaerat ipsa
              quibusdam, alias voluptate est perspiciatis odio hic?
            </p>
          </div>
