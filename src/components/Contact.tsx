...
export const Contact = () => {
  const [locationModelOpen, setLocationModalOpen] = useState<boolean>(false);
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 items-start gap-12">
            <div className="space-y-3 text-gray-800">
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleFormStateUpdate("message", e.target.value)
                }
                rows={6}
      ...
      {locationModelOpen && (
        <Modal setOpen={setLocationModalOpen} children={<LocationMap />} />
      )}
    </>
  );
};
